...
const index = () => {
  return (
    <div id="contact" className="w-full lg:h-full pt-4">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full">
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <div className="rounded-full shadow-custom-large shadow-gray-700 p-4 cursor-pointer hover:scale-120 ease-in duration-300">
